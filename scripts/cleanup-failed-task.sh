...
source "$ROOT/scripts/runtime-paths.sh"; repo="${REPO:-$ROOT}"; state_dir="${AUTONOMOUS_CLEANUP_STATE_DIR:-$(junie_cleanup_state_dir_default)}"; reason="autonomous task failed"
