...
- opencode subagent prompt formulation for Claude Opus 4.8 with low reasoning;
...
4. The orchestrator extracts only necessary context for opencode subagents powered by Claude Opus 4.8 with low reasoning and remains responsible for review, without doing coding work itself; Markdown-only docs/guidance maintenance is the direct-edit exception.
