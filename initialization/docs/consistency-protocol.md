...
- Current `MEMORY.md` and relevant docs.
...
- Guidance conflicts between `AGENTS.md`, `SOUL.md`, `TOOLS.md`, `HEARTBEAT.md`, `MEMORY.md`, `docs/`, `skills/`, or daily memory.
...
4. If semantic, risky, or unclear, create a change candidate and ask the owner/team.
