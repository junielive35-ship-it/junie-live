...
Use this file (or the project's chosen equivalent) to distinguish current reality from plans. Keep it current enough that future humans and agents can tell what is implemented, partial, contract-only, deferred, or unknown before accepting meaningful work.
