...
| Senior Dev Kanban delegation protocol docs | implemented | `distribution/docs/delegation-protocol.md`; `docs/architecture.md`; `docs/day-to-day-routines.md` | `create_senior_task` is the Chat Agent code-changing delegation path; `marinator_delegate` remains the senior-dev execution boundary under the `marinator` toolset. |
