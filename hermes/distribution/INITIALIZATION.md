...
1. Inspect your Hermes profile setup:
   - Your `SOUL.md` (personality + always-on operating rules) is auto-loaded each turn from your Hermes profile directory.
   - Check your installed skills with `skills_list`.
   - Read your profile docs from the profile `docs/` directory.
