...
| Watchdog/stuck worker handling       | `docs/overnight-routines.md`                                       | partial                               | `scripts/overnight-watchdog.sh`; cron schedule defaults; verify tests                                                  | Idle-safe; detects/cleans stale states; richer progress detection may still evolve. |
| Report generation                    | `docs/overnight-routines.md`                                       | partial                               | `scripts/overnight-report.sh`; verify smoke tests; kv format                                                           | Human and kv formats include backlog summary, commits-in-window, local failures, routine summary, and watchdog. Scheduled morning report is deprecated by default. |
