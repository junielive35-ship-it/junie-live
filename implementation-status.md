...
| Backlog scripts                      | `day_to_day_routines.md`                                           | partial                               | `scripts/backlog*.sh`; `next-action.sh`; verify smoke tests                                                            | Local file-backed workflow; no external issue tracker configured. Hygiene archives old blocked items to prevent indefinite accumulation. |
...
| Routine health check                 | `day_to_day_routines.md`                                           | partial                               | `scripts/routine-health.sh`; verify smoke tests                                                                        | Reports blocked items separately; warns on >3 blocked. Blocked items now archived by hygiene to prevent permanent WARNING.             |
