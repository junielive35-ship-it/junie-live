...
| Report generation                    | `docs/overnight-routines.md`                                       | partial                               | `scripts/overnight-report.sh`; verify smoke tests                                                                      | Scheduled morning report is deprecated by default; use on-demand or explicit enablement. |
